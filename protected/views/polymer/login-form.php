<polymer-element name="login-form" attributes="url">
    <template>
        <style>
            :host {
                display: block;
        ...
        <div class="centered card" layout horizontal vertical center>
            <div class="container">
                <div class="header">Sign In | <a class="nocolor" href="/site/register">Sign Up</a></div>
                ...
                <core-ajax id="ajax"
                           ...
                           url="{{url}}"
                           handleas="json"
                           params='{"LoginForm[username]":"{{username}}", "LoginForm[password]": "{{password}}", "LoginForm[rememberMe]": "{{rememberMe}}", "ajax": "login-form"}'
    ...
    <script>
        ...
        Polymer('login-form', {
            ready: function () {
                this.url = 'http://mo-web.loc/site/login';
                this.rememberMe = 1;
                loginForm = this;
            },
